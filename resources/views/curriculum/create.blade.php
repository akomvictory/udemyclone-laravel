...
<div class=" form-grids row form-grids-right">
	...
	<h4>Horizontal form :</h4>
		...
		<div class="form-body">
			<form class="form-horizontal" action="/curriculum/" method="POST"> 
           @csrf
           ...
           @if(count($all_courses)>0)
              ...
              @endif
                ...
                <label for="inputEmail3" class="col-sm-2 control-label">Video log Title</label>
                 <div class="col-sm-9"> 
                <input type="text" name="curriculum_title" placeholder="Changing photoshop canvas size" class="form-control" id="inputEmail3">
                 </div> 
                 </div> 
             
                 <div class="col-sm-offset-2">
                  <button type="submit" class="btn btn-default">Save </button> </div> </form> 
			</div>
		</div>
	</div>
</div>
