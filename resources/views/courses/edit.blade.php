...
<div class=" form-grids row form-grids-right">
	...
	<h4>Course category form :</h4>
		...
		<div class="form-body">
			<form class="form-horizontal" action="/course/{{$course->id}}" method="POST" enctype="multipart/form-data"> 
           @csrf
           @method('PUT')
                ...
                <label for="inputEmail3" class="col-sm-2 control-label">Course Title</label>
                 <div class="col-sm-9"> 
                 <input type="text" value="{{$course->course_title}}" name="course_title" placeholder="e.g Java beginner course" class="form-control" id="inputEmail3">
                 </div> 
                 </div> 
                ...
                <label for="inputEmail3" class="col-sm-2 control-label">Course Category</label>
                 ...
                 <option name="course_category" value="{{$category->category_heading}}">{{$category->category_heading}}</option>
                 @endforeach
                 </select>
              ...
              @if(count($all_instructors) >0 )
                ...
                <label for="inputEmail3" class="col-sm-2 control-label">Course Instructor</label>
                 ...
                 <option name="course_moderator" value="{{$instructor->instructor_name}}">{{$instructor->instructor_name}}</option>
                 @endforeach
                 </select>
                ...
                <label for="inputEmail3" class="col-sm-2 control-label">Course Price</label>
                 <div class="col-sm-9"> 
                 <input type="number" value="{{$course->course_price}}" name="course_price" placeholder="e.g #5000" class="form-control" id="inputEmail3">
                 </div> 
                 </div> 
                ...
                <label for="inputEmail3" class="col-sm-2 control-label">Course Description</label>
                 <div class="col-sm-9"> 
                 <textarea class="form-control" name="course_description" rows="5"> {{$course->course_description}} </textarea>                 </div> 
                 </div> 
